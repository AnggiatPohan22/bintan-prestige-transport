export const routes = [
  ...
  },
  {
    ...
    description: "Used Hiace for larger groups or families who need a comfortable private taxi transfer from airport, ferry, or hotel to their destination.",
    overview:
    ...
    highlights: [
      "Private Hiace for airport, ferry, or hotel transfer",
      "Comfortable ride for larger groups or families",
      "Flexible pickup and drop-off locations",
      "Optional multi-stop arrangements for sightseeing",
    ],
    packageDetails: [
  ...
  },
  {
    ...
    description: "Luxury transfer service using Alphard for VIP guests who want a premium private taxi experience from airport, ferry, or hotel to their destination.",
    overview:
    ...
    highlights: [
      "Luxury Alphard for airport, ferry, or hotel transfer",
      "Premium private taxi experience for VIP guests",
      "Flexible evening transfer options",
